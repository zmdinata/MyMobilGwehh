...
export const metadata = {
  ...
  description: 'Game side-scrolling 2D fisika tentang Mas Tion mengantar 500 porsi gizi hangat menuju SD, SMP, SMA Puspa Bangsa Cirebon didampingi Mang Ucup.',
  icons: {
